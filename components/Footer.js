        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-secondary-300 max-w-md">
              ...
              Quality craftsmanship meets modern style for the discerning individual.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/shop" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Shop
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/collections/travel" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Travel Collection
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/shipping" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Shipping Info
                </Link>
              </li>
              <li>
                <Link href="/returns" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Returns & Exchanges
                </Link>
              </li>
              <li>
                <Link href="/size-guide" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Size Guide
                </Link>
              </li>
              <li>
                <Link href="/care-instructions" className="text-secondary-300 hover:text-primary-400 transition-colors">
                  Care Instructions
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-secondary-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-secondary-400 text-sm">
              © {new Date().getFullYear()} RebelByGrace. All rights reserved.
            </div>
